...
// This file contains the definition of the class CylindericalMap
...
class CylindericalMap: public Mapping {		
	public:
	
		CylindericalMap(void);									
		
		CylindericalMap(const CylindericalMap& sm);					

		CylindericalMap& 											
		operator= (const CylindericalMap& rhs);		

		virtual CylindericalMap*									
		clone(void) const;				
