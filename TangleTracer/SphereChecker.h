...
inline void
SphereChecker::set_num_vertical(const int num_vertical)
{
	num_vertical_checkers = num_vertical;
}

inline void													
SphereChecker::set_num_horizontal(const int num_horizontal)
{
	num_horizontal_checkers = num_horizontal;
}
...
inline void
SphereChecker::set_numlong(const int num)
{
	this->num_horizontal_checkers = num;
}
		
inline void
SphereChecker::set_numlat(const int num)
{
	this->num_vertical_checkers = num;
}
		
inline void
SphereChecker::set_line_width(const float wid)
{
