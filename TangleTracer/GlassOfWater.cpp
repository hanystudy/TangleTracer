...
GlassOfWater::build_components(void) {
	...
	objects.push_back(new ConcavePartCylinder(	water_height + meniscus_radius, // inner curved surface of glass
												height, 
												inner_radius )); 
																	 
	objects.push_back(new ConvexPartCylinder(	0, 								// outer curved surface of glass
												height, 
												inner_radius + wall_thickness));
	...
	objects.push_back(new ConvexPartCylinder(	base_thickness,					// curved surface of water
	...
	Instance* meniscus_ptr = new Instance (new ConcavePartTorus(inner_radius - meniscus_radius,
																meniscus_radius,
