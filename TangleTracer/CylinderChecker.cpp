...
CylinderChecker::CylinderChecker(void)
	:	Texture(),
...
CylinderChecker::CylinderChecker(const double height):
		Texture(),
		num_horizontal_checkers(20),
		num_vertical_checkers(10),
		horizontal_line_width(0.0),
...
CylinderChecker::CylinderChecker(const CylinderChecker& sc)
	: 	Texture(sc),
...
CylinderChecker& 
CylinderChecker::operator= (const CylinderChecker& rhs) 	
{
	if (this == &rhs)
		return (*this);
...
CylinderChecker*										
CylinderChecker::clone(void) const {
...
RGBColor																				
CylinderChecker::get_color(const ShadeRec& sr) const {
