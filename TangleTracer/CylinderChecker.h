...
//-----------------------------------------------------------------------------------class CylinderChecker

class CylinderChecker: public Texture {		
	public:
	
		CylinderChecker(void);					

		CylinderChecker(const double height);
		
		CylinderChecker(const CylinderChecker& sc);
		
		CylinderChecker& 												
		operator= (const CylinderChecker& rhs);		

		virtual CylinderChecker*							
		clone(void) const;				
...
inline void													
CylinderChecker::set_num_horizontal_checkers(const int num_horizontal) {
	num_horizontal_checkers = num_horizontal;
}

inline void													
CylinderChecker::set_num_vertical_checkers(const int num_vertical) {
	num_vertical_checkers = num_vertical;
}

inline void													
CylinderChecker::set_horizontal_line_width(const float width) {
	horizontal_line_width = width;
}

inline void													
CylinderChecker::set_vertical_line_width(const float width) {
	vertical_line_width = width;
}
		
inline void																	
CylinderChecker::set_color1(const float r, const float g, const float b) {
	color1.r = r; color1.g = g; color1.b = b;
}

inline void																
CylinderChecker::set_color1(const float c) {
	color1.r = c; color1.g = c; color1.b = c;
}

inline void																
CylinderChecker::set_color1(const RGBColor& c) {
color1.r = c.r; color1.g = c.g; color1.b = c.b;
}

inline void																	
CylinderChecker::set_color2(const float r, const float g, const float b) {
	color2.r = r; color2.g = g; color2.b = b;
}

inline void																
CylinderChecker::set_color2(const float c) {
	color2.r = c; color2.g = c; color2.b = c;
}

inline void																
CylinderChecker::set_color2(const RGBColor& c) {
color2.r = c.r; color2.g = c.g; color2.b = c.b;
}											

inline void																	
CylinderChecker::set_line_color(const float r, const float g, const float b) {
	line_color.r = r; line_color.g = g; line_color.b = b;
}

inline void																	
CylinderChecker::set_line_color(const float c) {
	line_color.r = c; line_color.g = c; line_color.b = c;
}

inline void																	
CylinderChecker::set_line_color(const RGBColor& c) {
