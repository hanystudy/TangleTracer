...
// ----------------------------------------------------------------  default constructor
// a default ConvexPartCylinder is a whole sphere
...
ConvexPartCylinder::ConvexPartCylinder (const double 	bottom, 
							const double 	top, 
							const double 	r,
	...
	: 	GeometricObject(),
		...
		y0(bottom),			// bottom
		y1(top),			// top
		polar_min(polar_min*PI_ON_180),			// in radians
		polar_max(polar_max*PI_ON_180)		// in radians	
{
	inv_radius = 1/r;
}
...
ConvexPartCylinder::ConvexPartCylinder (const ConvexPartCylinder& ps)
	: 	GeometricObject(ps),
		radius(ps.radius),
		y0(ps.y0),			// bottom
		y1(ps.y1),			// top
